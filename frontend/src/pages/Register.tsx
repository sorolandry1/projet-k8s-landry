...
import { ChefHat, Mail, User, Lock, ArrowRight, AlertCircle, CheckCircle } from 'lucide-react'
...
export default function Register(){
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(e?.response?.data?.detail || 'Erreur lors de l\'inscription. Veuillez réessayer.')
    } finally {
      setLoading(false)
    }
  }
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-warm-cream via-white to-secondary-50 flex items-center justify-center py-12 px-4">
      ...
      <div className="relative max-w-md w-full space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-soft p-8 space-y-6">
            ...
            <div className="flex items-start gap-3 pt-2">
              ...
              <label htmlFor="terms" className="text-sm text-gray-600">
                J'accepte les{' '}
                <button type="button" className="text-primary hover:text-primary-dark font-semibold transition-colors">
                  conditions d'utilisation
                </button>
                {' '}et la{' '}
                <button type="button" className="text-primary hover:text-primary-dark font-semibold transition-colors">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-transparent text-gray-500 font-medium">Ou s'inscrire avec</span>
          </div>
        </div>
